...
const routes: FastifyPluginAsync = async (app: FastifyInstance) => {
  ...
  // POST /tags/:id/assign   body: { contactId? | organizationId? | animalId? | messageThreadId? | draftId? | breedingPlanId? | offspringId? | documentId? }
  ...
  app.post("/tags/:id/assign", async (req, reply) => {
    try {
      ...
      const body = (req.body || {}) as { contactId?: number; organizationId?: number; animalId?: number; messageThreadId?: number; draftId?: number; breedingPlanId?: number; offspringId?: number; documentId?: number };
      const targets = ["contactId", "organizationId", "animalId", "messageThreadId", "draftId", "breedingPlanId", "offspringId", "documentId"].filter((k) => (body as any)[k] != null);
  ...
  // POST /tags/:id/unassign   body: { contactId? | organizationId? | animalId? | messageThreadId? | draftId? | breedingPlanId? | offspringId? | documentId? }
